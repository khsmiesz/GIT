...
class PrivateCards(BusinessCard):
    def __init__(self, relation, name, surname, company, position, email):
        super().__init__(name, surname, company, position, email)
        self.relation=relation
    def __str__(self):
        return super().__str__(self.relation)
momscard=PrivateCards("mama", "Anna", "Płotkowiak", "MasterMing", "Supervisor", "supemaster@yahoo.pl")
